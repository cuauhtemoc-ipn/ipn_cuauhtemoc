...
const membcard = (
  <div className='d-flex justify-content-center align-items-center my-4 col-12 col-sm-10 col-md-9 col-lg-6'>
    <div className='card align-items-center bg-light bg-opacity-50 text-light col-12 col-lg-11 col-xl-10'>
      <div className='row justify-content-center align-items-center no-gutters col-12'>
        <div className='col-6 col-xl-5 p-0 mx-0'>
          <div className='ratio ratio-1x1'>
            <img src={sub1} className='card-img' alt='...' />
          </div>
        </div>
        <div className='px-0 col-6 col-xl-7'>
